...
def upgrade():
    ...
    op.add_column(
        "etc_data_habitattype_automatic_assessment",
        sa.Column(
            "percentage_assessment_trend_unfavourable",
    ...
    op.add_column(
        "etc_data_habitattype_automatic_assessment",
        sa.Column(
            "percentage_hab_condition_trend", sa.String(length=100), nullable=True
        ),
    )
    op.add_column(
        "etc_data_habitattype_automatic_assessment",
    ...
    op.add_column(
        ...
        sa.Column("coverage_etc", sa.Float(asdecimal=True), nullable=True),
    )
    op.add_column(
        "etc_data_habitattype_regions",
        sa.Column(
            "percentage_hab_condition_good", sa.Float(asdecimal=True), nullable=True
        ),
    )
...
def downgrade():
    ...
    op.drop_column(
        "etc_data_habitattype_automatic_assessment", "percentage_range_trend"
    )
    op.drop_column(
        "etc_data_habitattype_automatic_assessment", "percentage_hab_condition_trend"
    )
    op.drop_column(
        "etc_data_habitattype_automatic_assessment", "percentage_coverage_trend"
    )
    op.drop_column(
        "etc_data_habitattype_automatic_assessment",
        "percentage_assessment_trend_unfavourable",
    ...
    op.drop_column(
        "etc_data_habitattype_automatic_assessment", "coverage_surface_area_min"
    )
    op.drop_column(
        "etc_data_habitattype_automatic_assessment", "coverage_surface_area_max"
    )

...
def upgrade():
    with op.batch_alter_table(
        ...
        batch_op.add_column(
            sa.Column("population_size_class", sa.String(length=50), nullable=True)
        )
        batch_op.add_column(
            sa.Column(
        ...
        batch_op.add_column(
            sa.Column(
                "complementary_favourable_population_predefined",
                sa.String(length=100),
                nullable=True,
            )
        )
        ...
        batch_op.add_column(
            sa.Column(
                "population_trend_magnitude_etc", sa.String(length=100), nullable=True
            )
        )

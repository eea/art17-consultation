...
def upgrade():
    op.create_table(
        ...
        sa.Column("shortname", sa.String(length=155), nullable=False),
        sa.Column("annex_I_comments", sa.String(length=30), nullable=True),
        sa.Column("marine", sa.Integer(), nullable=True),
        sa.Column("nameheader", sa.String(length=155), nullable=False),

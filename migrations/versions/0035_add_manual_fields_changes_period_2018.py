...
def upgrade():
    op.add_column(
        ...
        sa.Column(
            "complementary_favourable_area_q", sa.String(length=2), nullable=True
        ),
    )
    op.add_column(
        "habitattypes_manual_assessment",
        sa.Column(
            "complementary_favourable_range_q", sa.String(length=2), nullable=True
        ),
    )
    op.add_column(
        "habitattypes_manual_assessment",
    ...
    op.add_column(
        ...
        sa.Column(
            "complementary_favourable_population_q", sa.String(length=2), nullable=True
        ),
    )
    op.add_column(
        "species_manual_assessment",

...
def upgrade():
    ...
    op.add_column(
        "etc_data_habitattype_automatic_assessment",
        sa.Column(
            "coverage_surface_area_min_max", sa.String(length=100), nullable=True
        ),
    )
    op.add_column(
        "etc_data_habitattype_automatic_assessment",
    ...
    op.add_column(
        "etc_data_habitattype_automatic_assessment",
        sa.Column(
            "percentage_assessment_trend_change", sa.String(length=100), nullable=True
        ),
    )
    op.add_column(
        "etc_data_habitattype_automatic_assessment",
    ...
    op.add_column(
        "etc_data_species_automatic_assessment",
        sa.Column(
            "habitat_sufficiency_unoccupied", sa.String(length=20), nullable=True
        ),
    )
    op.add_column(
        "etc_data_species_automatic_assessment",
        sa.Column(
            "percentage_assessment_trend_change", sa.String(length=200), nullable=True
        ),
    )
    op.add_column(
        "etc_data_species_automatic_assessment",
        sa.Column(
            "percentage_habitat_sufficiency", sa.String(length=20), nullable=True
        ),
    )
    op.add_column(
        "etc_data_species_automatic_assessment",
...
def downgrade():
    ...
    op.drop_column(
        "etc_data_species_automatic_assessment", "percentage_habitat_sufficiency"
    )
    op.drop_column(
        "etc_data_species_automatic_assessment", "percentage_assessment_trend_change"
    )
    op.drop_column(
        "etc_data_species_automatic_assessment", "habitat_sufficiency_unoccupied"
    )
    op.drop_column(
        "etc_data_species_automatic_assessment", "habitat_sufficiency_occupied"
    )
    ...
    op.drop_column(
        "etc_data_species_automatic_assessment", "conclusion_assessment_trend_prev"
    )
    op.drop_column(
        "etc_data_species_automatic_assessment",
        "complementary_favourable_population_unit",
    ...
    op.drop_column(
        "etc_data_habitattype_automatic_assessment", "conclusion_assessment_trend_prev"
    )
    ...
    op.drop_column(
        "etc_data_habitattype_automatic_assessment", "coverage_surface_area_min_max"
    )

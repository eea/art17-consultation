...
def upgrade():
    ...
    with op.batch_alter_table("etc_data_species_regions", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                "S_5_12_b_favourable_reference_range_predefined",
                sa.String(length=23),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "S_6_2_e_population_size_class", sa.String(length=23), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
                "S_6_4_population_size_quality_of_extrapolation",
                sa.String(length=23),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "S_6_11_a_short_term_trend_magnitude_min",
        ...
        batch_op.add_column(
            sa.Column(
                "S_6_11_b_short_term_trend_magnitude_max",
                sa.Float(asdecimal=True),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "S_6_11_c_short_term_trend_magnitude_predefined",
                sa.String(length=50),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "S_6_11_d_short_term_trend_magnitude_unknown",
                sa.Boolean(),
                nullable=True,
            )
        )
        ...
        batch_op.add_column(
            sa.Column(
                "S_6_18_c_favourable_reference_population_unknown",
                sa.Boolean(),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "derived_favourable_reference_population_combined",
                sa.String(length=23),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "S_6_18_b_favourable_reference_population_predefined",
                sa.String(length=23),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "S_7_1_b_habitat_sufficiency_occupied_quality",
                sa.String(length=25),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "S_7_2_habitat_sufficiency_method_quality",
                sa.String(length=25),
                nullable=True,
            )
        )

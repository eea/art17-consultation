...
RUN runDeps="curl gcc vim build-essential netcat-traditional python-dev-is-python3 libldap2-dev libsasl2-dev libssl-dev libldap-common libxrender1 libfontconfig1 libxext6 wkhtmltopdf" \
	&& apt-get update \

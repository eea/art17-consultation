revision = 'c122097193c'
down_revision = '441a1e3ddfc3'
...
def upgrade():
    op.add_column('species_manual_assessment', sa.Column('complementary_favourable_population_unit',
                  sa.String(length=20), nullable=True))

    op.add_column('species_manual_assessment', sa.Column('future_habitat',
                  sa.String(length=20), nullable=True))
    op.add_column('species_manual_assessment', sa.Column('future_population',
                  sa.String(length=20), nullable=True))
    op.add_column('species_manual_assessment', sa.Column('future_range',
                  sa.String(length=20), nullable=True))
    ...
    op.add_column('species_manual_assessment', sa.Column('conclusion_assessment_trend_prev',
                  sa.String(length=20), nullable=True))
    op.drop_column('species_manual_assessment', 'conclusion_assessment_prev_trend')
    op.add_column('species_manual_assessment', sa.Column('conclusion_assessment_trend_change',
                  sa.String(length=20), nullable=True))
    ...
    op.alter_column('species_manual_assessment', 'population_best_value',
                    existing_type=sa.Float(asdecimal=True), type_=sa.String(length=23))
...
def downgrade():
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('trend_structure', mysql.FLOAT(), nullable=True))
    ...
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('conclusion_assessment_change_trend', mysql.VARCHAR(length=20), nullable=True))
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('conclusion_assessment_prev_trend', mysql.VARCHAR(length=20), nullable=True))
    op.drop_column('habitattypes_manual_assessment', 'conclusion_assessment_trend_prev')
    op.drop_column('habitattypes_manual_assessment', 'conclusion_assessment_trend_change')
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('structure_future_prospects', mysql.VARCHAR(length=20), nullable=True))
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('area_future_prospects', mysql.VARCHAR(length=20), nullable=True))
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('range_future_prospects', mysql.VARCHAR(length=20), nullable=True))
    ...
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('good_structure', mysql.FLOAT(), nullable=True))
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('best_value_area', mysql.FLOAT(), nullable=True))
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('not_known_structure', mysql.FLOAT(), nullable=True))
    op.add_column('habitattypes_manual_assessment',
                  sa.Column('not_good_structure', mysql.FLOAT(), nullable=True))
    ...
    op.alter_column('species_manual_assessment', 'population_best_value',
                    existing_type=sa.String(length=23), type_=sa.Float(asdecimal=True))
    op.drop_column('species_manual_assessment', 'backcasted_2007')
    op.add_column('species_manual_assessment',
                  sa.Column('conclusion_assessment_change_trend', mysql.VARCHAR(length=20), nullable=True))
    op.drop_column('species_manual_assessment',
                   'conclusion_assessment_trend_change')
    op.add_column('species_manual_assessment',
                  sa.Column('conclusion_assessment_prev_trend', mysql.VARCHAR(length=20), nullable=True))
    op.drop_column('species_manual_assessment', 'conclusion_assessment_trend_prev')
    op.add_column('species_manual_assessment', 
        sa.Column('habitat_future_prospects', mysql.VARCHAR(length=20), nullable=True))
    op.add_column('species_manual_assessment', 
        sa.Column('range_future_prospects', mysql.VARCHAR(length=20), nullable=True))
    op.add_column('species_manual_assessment',
        sa.Column('population_future_prospects', mysql.VARCHAR(length=20), nullable=True))
    ...
    op.drop_column('species_manual_assessment', 'complementary_favourable_population_unit')

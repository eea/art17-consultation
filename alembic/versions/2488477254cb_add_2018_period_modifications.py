...
def upgrade():
    ...
    op.add_column('etc_data_habitattype_automatic_assessment',
                  sa.Column('coverage_surface_area_min_max', sa.Float(asdecimal=True), nullable=True))
    op.add_column('etc_data_habitattype_automatic_assessment', 
    ...
    op.add_column('etc_data_habitattype_automatic_assessment',
                  sa.Column('hab_condition_trend', sa.Float(asdecimal=True), nullable=True))
    op.add_column('etc_data_habitattype_automatic_assessment',
                  sa.Column('hab_condition_unknown', sa.Float(asdecimal=True), nullable=True))
    op.add_column('etc_data_habitattype_automatic_assessment',
                  sa.Column('percentage_assessment_trend_change', sa.String(length=20), nullable=True))
    op.add_column('etc_data_habitattype_automatic_assessment',
    ...
    op.add_column('etc_data_habitattype_regions',
                  sa.Column('distribution_method_area', sa.String(length=50), nullable=True))
    op.add_column('etc_data_habitattype_regions',
                  sa.Column('future_area', sa.String(length=20), nullable=True))
    op.add_column('etc_data_habitattype_regions',
                  sa.Column('future_range', sa.String(length=20), nullable=True))
    ...
    op.add_column('etc_data_species_automatic_assessment',
                  sa.Column('population_size_min_max', sa.Float(asdecimal=True), nullable=True))
    op.add_column('etc_data_species_automatic_assessment',

...
class EtcDataHabitattypeAutomaticAssessment(Base):
    ...
    coverage_surface_area_min_max = Column(Float(asdecimal=True))
    ...
    hab_condition_trend = Column(Float(asdecimal=True))
    ...
    percentage_assessment_trend_change = Column(String(20))
...
class EtcDataSpeciesAutomaticAssessment(Base):
    ...
    range_yearly_magnitude = Column(String(100))
    complementary_favourable_range = Column(String(100))
    population_size_min_max = Column(Float(asdecimal=True))

    ...
    def stats(self):
        ...
        return {
            ...
            "species_auto": get_count(
                EtcDataSpeciesAutomaticAssessment.query.filter_by(dataset_id=self.id)
            ),
            "species_manual": get_count(
                SpeciesManualAssessment.query.filter_by(dataset_id=self.id)
            ),
            "habitat_content": get_count(
                EtcDataHabitattypeRegion.query.filter_by(dataset_id=self.id)
            ),
            ...
            "habitat_manual": get_count(
                HabitattypesManualAssessment.query.filter_by(dataset_id=self.id)
            ),
        }
...
class EtcDataHabitattypeAutomaticAssessment(Base):
    ...
    hab_condition_good = Column(String(100))
    hab_condition_notgood = Column(String(100))
    hab_condition_unknown = Column(String(100))
    ...
    conclusion_assessment_trend = Column(String(3))
...
class EtcDataHabitattypeRegion(Base):
    ...
    habitattype_type_asses = Column(Boolean)
    ...
    H_5_8_a_short_term_trend_magnitude_min = Column(String(50))
    H_5_8_b_short_term_trend_magnitude_max = Column(String(50))
    H_5_8_c_short_term_trend_magnitude_predefined = Column(String(50))
    H_5_8_d_short_term_trend_magnitude_unknown = Column(String(50))
    derived_area_trend_magnitude = Column(String(50))
    derived_favourable_reference_range_combined = Column(String(23))
    derived_favourable_reference_range_min = Column(String(100))
    derived_favourable_reference_range_max = Column(String(100))
    derived_favourable_reference_range_mean = Column(String(100))
    H_4_12_b_favourable_reference_range_predefined = Column(String(23))
    complementary_favourable_area_q = Column(String(2))
    complementary_favourable_area = Column(Float(asdecimal=True))
    derived_favourable_reference_area_combined = Column(String(23))
    derived_favourable_reference_area_min = Column(String(100))
    derived_favourable_reference_area_max = Column(String(100))
    derived_favourable_reference_area_mean = Column(String(100))
    H_5_15_b_favourable_reference_area_predefined = Column(String(23))
    ...
    derived_condition_good_mean = Column(Float(asdecimal=True))
    derived_condition_notgood_mean = Column(Float(asdecimal=True))
    derived_condition_unknown_mean = Column(Float(asdecimal=True))
...
class EtcDataSpeciesAutomaticAssessment(Base):
    ...
    population_size_class = Column(String(50))
    ...
    complementary_favourable_population_predefined = Column(String(100))
    derived_favourable_reference_population_min = Column(String(100))
    derived_favourable_reference_population_max = Column(String(100))
    derived_favourable_reference_population_mean = Column(String(100))
    complementary_favourable_population_unit = Column(String(20))
    population_trend_magnitude_etc = Column(String(100))
...
class EtcDataSpeciesRegion(Base):
    ...
    population_alt_size_unit = Column(String(50))
    ...
    population_trend = Column(String(10))
    ...
    habitat_trend = Column(String(10))
...
class EtcDicBiogeoreg(Base):
    ...
    def get_region_name(cls, reg_code, dataset_id):
        return (
            ...
            .filter(cls.reg_code == reg_code, cls.dataset_id == dataset_id)
            .first()
        )
...
class EtcDicConclusion(Base):
    ...
    def all(cls, dataset_id):
        return (
            cls.query.with_entities(cls.conclusion)
            .filter_by(dataset_id=dataset_id)
            .order_by(cls.conclusion)
        )
...
class HabitattypesManualAssessment(Base):
    ...
    range_surface_area = Column(String(50))
    range_trend = Column(String(3))
    range_yearly_magnitude = Column(String(50))
    complementary_favourable_range = Column(String(50))
    complementary_favourable_range_q = Column(String(2))
    derived_perc_range_FRR = Column(String(100))
    coverage_surface_area = Column(String(50))
    coverage_surface_area_min = Column(String(50))
    coverage_surface_area_max = Column(String(50))
    coverage_trend = Column(String(3))
    coverage_yearly_magnitude = Column(String(50))
    complementary_favourable_area = Column(String(50))
    complementary_favourable_area_q = Column(String(2))
    derived_perc_area_FRA = Column(String(100))
    ...
    hab_condition_good_min = Column(String(50))
    hab_condition_good_max = Column(String(50))
    hab_condition_good_best = Column(String(50))
    hab_condition_notgood = Column(String(50))
    hab_condition_notgood_min = Column(String(50))
    hab_condition_notgood_max = Column(String(50))
    hab_condition_notgood_best = Column(String(50))
    hab_condition_unknown = Column(String(50))
    hab_condition_unknown_min = Column(String(50))
    hab_condition_unknown_max = Column(String(50))
    hab_condition_unknown_best = Column(String(50))
    ...
    conclusion_assessment_trend = Column(String(10))
    conclusion_assessment_prev = Column(String(3))
    conclusion_assessment_trend_prev = Column(String(20))
    conclusion_assessment_change = Column(String(20))
    conclusion_assessment_trend_change = Column(String(20))
    ...
    def undeleted_comments(self, user_id):
        ...
        return [
            ...
            if not c.deleted
            or c.author_id == user_id
            or (user and user.has_role("admin"))
        ]
...
class SpeciesManualAssessment(Base):
    ...
    conclusion_assessment_prev = Column(String(3))
    conclusion_assessment_trend_prev = Column(String(20))
    conclusion_assessment_change = Column(String(10))
    conclusion_assessment_trend_change = Column(String(20))
    method_target1 = Column(String(3))
    conclusion_target1 = Column(String(3))
    backcasted_2007 = Column(String(4))
...
class LuSpeciesManual2007(Base):
    ...
    conclusion_assessment_trend_prev = Column(

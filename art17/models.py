...
class EtcDataHabitattypeAutomaticAssessment(Base):
    ...
    best_value_area = Column(Float(asdecimal=True))
    type_estimate_area = Column(String(50))
    method_area = Column(String(50))
    conclusion_area = Column('conclusion_coverage', String(3))
    conclusion_area_gis = Column('conclusion_coverage_gis', String(3))
    good_structure = Column(Float(asdecimal=True))
    not_good_structure = Column(Float(asdecimal=True))
    not_known_structure = Column(Float(asdecimal=True))
    trend_structure = Column(Float(asdecimal=True))
    ...
    structure_future_prospects = Column(String(20))
...
class EtcDataSpeciesAutomaticAssessment(Base):
    ...
    population_size_type_estimate = Column(String(50))
    ...
    habitat_occupied_sufficiency = Column(String(20))
    habitat_unoccupied_sufficiency = Column(String(20))
...
class HabitattypesManualAssessment(Base):
    ...
    range_future_prospects = Column(String(20))
    area_future_prospects = Column(String(20))
    structure_future_prospects = Column(String(20))
    ...
    backcasted_2007 = Column(String(3))

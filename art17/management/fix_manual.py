...
def run(**kwargs):
    ...
    for specie in species:
        ...
        specie.conclusion_assessment_trend_change = translation(
            specie.conclusion_assessment_trend_change
        )
    ...
    for habitat in habitats:
        ...
        habitat.conclusion_assessment_trend_change = translation(
            habitat.conclusion_assessment_trend_change
        )

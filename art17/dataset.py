...
IMPORT_SCHEMA = {
    "2006": [
        ("dic_country_codes", ["code", "codeEU", "name"]),
        (
        ...
        ("etc_dic_biogeoreg", ["reg_code", "reg_name", "ordine", "order"]),
        ("etc_dic_conclusion", ["order", "conclusion", "details"]),
        ("etc_dic_decision", ["order", "decision", "details"]),
        (
            "etc_dic_hd_habitats",
            [
                "habcode",
        ...
        (
            ...
            ["SpeciesTypeID", "SpeciesType", "Assessment", "Note", "abbrev"],
        ),
        ("etc_dic_trend", ["id", "trend", "details"]),
        (
        ...
        (
            "restricted_species",
            ["assessment_speciesname", "eu_country_code", "show_data"],
        ),
        (
        ...
        ("wiki", ["id", "region", "assessment_speciesname", "habitatcode"]),
        (
            "wiki_trail",
            ["id", "region", "assessment_speciesname", "habitatcode"],
        ),
        (
            "wiki_changes",
    ...
    "2012": [
        ...
        (
            ...
            [
                ...
                "percentage_distribution_grid_area",
                "assessment_needed",
                "percentage_assessment_trend",
                "conclusion_assessment_trend",
                "percentage_assessment_change",
        ...
        (
            ...
            [
                ...
                "percentage_distribution_grid_area",
                "range_change_reason",
                "population_change_reason",
                "habitat_change_reason",
                "population_units_agreed",
                "population_units_other",
                "conclusion_assessment_trend",
                "conclusion_assessment_prev",
                "conclusion_assessment_change",
            ],

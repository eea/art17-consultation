    ...
    def get_context(self):
        ...
        return {
            ...
            "edit_page_url": url_for(
                self.editpage_endpoint, page=self.page, **request_args
            ),
    ...
    def get_context(self):
        ...
        if request.args.get("merged") == "merged":
            ...
            context.update(
                {
                    "back_url": url_for(
                        ".audittrail-merged", page=self.page, **request_args
                    )
                }
            )
        return context
...
wiki.add_url_rule(
    "/<page>/summary/datasheet/",
    view_func=WikiView.as_view("datasheet", section=DataSheetSection),
)

wiki.add_url_rule(
    "/<page>/summary/datasheet/page_history/",
    view_func=PageHistory.as_view("ds-page-history", section=DataSheetSection),
)

wiki.add_url_rule(
    "/<page>/summary/datasheet/add_comment/",
    view_func=AddComment.as_view("ds-add-comment", section=DataSheetSection),
)

wiki.add_url_rule(
    "/<page>/summary/datasheet/edit_page/",
    view_func=EditPage.as_view("ds-edit-page", section=DataSheetSection),
)

wiki.add_url_rule(
    "/<page>/summary/datasheet/edit_comment/",
    view_func=EditComment.as_view("ds-edit-comment", section=DataSheetSection),
)
...
wiki.add_url_rule(
    "/<page>/summary/datasheet/get_revision/",
    view_func=GetRevision.as_view("ds-get-revision", section=DataSheetSection),
)

wiki.add_url_rule(
    "/<page>/summary/audittrail/",
    view_func=WikiView.as_view("audittrail", section=AuditTrailSection),
)
...
wiki.add_url_rule(
    "/<page>/summary/audittrail/page_history/",
    view_func=PageHistory.as_view("at-page-history", section=AuditTrailSection),
)

wiki.add_url_rule(
    "/<page>/summary/audittrail/edit_page/",
    view_func=EditPage.as_view("at-edit-page", section=AuditTrailSection),
)

wiki.add_url_rule(
    "/<page>/summary/audittrail/get_revision/",
    view_func=GetRevision.as_view("at-get-revision", section=AuditTrailSection),
)

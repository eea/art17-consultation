...
@pytest.mark.parametrize(
    ...
    [('post', ['/species/comments/1/Canis lupus/BOR/someuser/',
     ...
     ('get', ['/species/comments/1/Canis lupus/BOR/someuser/',
      ...
      {}, [], True, 403, ""),
     ('get', ['/species/comments/1/Canis lupus/BOR/someuser/',
      {'MS': 'EU27', 'delete': 1, 'deleted': 0}], {}, [], True, 403, ""),
     ...
     ('get', ['/species/comments/1/Canis lupus/BOR/someuser/',
      {'MS': 'EU27', 'toggle': 1, 'read': False}], {}, ['testuser'], True, 403,
      ""),
     ('get', ['/species/comments/1/Canis lupus/BOR/someuser/',
      {'MS': 'EU27', 'delete': 1, 'deleted': 0}], {}, ['testuser'], False, 200,
     ...
     ('post', ['/species/comments/1/Canis lupus/BOR/someuser/',
      ...
      ""),
     ('get', ['/species/comments/1/Canis lupus/BOR/someuser/',
      {'MS': 'EU27', 'toggle': 1, 'read': False}], {}, ['newuser'], False, 200,
      "'Mark as unread' in resp.html.text"),
     ('get', ['/species/comments/1/Canis lupus/BOR/someuser/',
      {'MS': 'EU27', 'delete': 1, 'deleted': 0}], {}, ['newuser'], True, 403,
      ""),
     ...
     ('get', ['/habitat/comments/1/1110/MATL/someuser/',
      {'MS': 'EU27', 'toggle': 1, 'read': False}], {}, [], True, 403, ""),
     ('get', ['/habitat/comments/1/1110/MATL/someuser/',
      {'MS': 'EU27', 'delete': 1, 'deleted': 0}], {}, [], True, 403, ""),
     # User that posted a comment already
     ('post', ['/habitat/comments/1/1110/MATL/someuser/', {'MS': 'EU27', }],

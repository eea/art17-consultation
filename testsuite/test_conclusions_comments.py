...
@pytest.mark.parametrize(
    ...
    # Species
    # Anonymous user
    [('post', ['/species/comments/5/Canis lupus/BOR/someuser/',
               {'MS': 'EU28'}],
      {'comment': 'I cannot post comments'}, [], True, 403, ""),
     ('post', ['/species/comments/5/Canis lupus/BOR/someuser/',
               {'MS': 'EU28', 'edit': 1}],
      {'comment': 'I cannot edit this comment'}, [], True, 403, ""),
     ('get', ['/species/comments/5/Canis lupus/BOR/someuser/',
              {'MS': 'EU28', 'toggle': 1, 'read': False}],
      {}, [], True, 403, ""),
     ('get', ['/species/comments/5/Canis lupus/BOR/someuser/',
      {'MS': 'EU28', 'delete': 1, 'deleted': 0}], {}, [], True, 403, ""),
     ...
     ('get', ['/species/comments/5/Canis lupus/BOR/someuser/',
      {'MS': 'EU28', 'toggle': 1, 'read': False}], {}, ['testuser'], True, 403,
      ""),
     ('get', ['/species/comments/5/Canis lupus/BOR/someuser/',
      {'MS': 'EU28', 'delete': 1, 'deleted': 0}], {}, ['testuser'], False, 200,
     ...
     ('post', ['/species/comments/5/Canis lupus/BOR/someuser/',
      ...
      ""),
     ('get', ['/species/comments/5/Canis lupus/BOR/someuser/',
      {'MS': 'EU28', 'toggle': 1, 'read': False}], {}, ['newuser'], False, 200,
      "'Mark as unread' in resp.html.text"),
     ('get', ['/species/comments/5/Canis lupus/BOR/someuser/',
      {'MS': 'EU28', 'delete': 1, 'deleted': 0}], {}, ['newuser'], True, 403,
      ""),
     # User with admin role
     ('get', ['/species/comments/5/Canis lupus/BOR/someuser/',
      {'MS': 'EU28', 'delete': 1, 'deleted': 0}], {}, ['adminuser', ['admin']],
      False, 200, "'Undelete' in resp.html.text"),
     # Habitat
     # Anonymous user
     ('post', ['/habitat/comments/5/1110/MATL/someuser/', {'MS': 'EU28', }],
      {'comment': 'I cannot post comments'}, [], True, 403, ""),
     ('post', ['/habitat/comments/5/1110/MATL/someuser/',
               {'MS': 'EU28', 'edit': 1}],
      {'comment': 'I cannot edit this comment'}, [], True, 403, ""),
     ('get', ['/habitat/comments/5/1110/MATL/someuser/',
      {'MS': 'EU28', 'toggle': 1, 'read': False}], {}, [], True, 403, ""),
     ('get', ['/habitat/comments/5/1110/MATL/someuser/',
      {'MS': 'EU28', 'delete': 1, 'deleted': 0}], {}, [], True, 403, ""),
     # User that posted a comment already
     ('post', ['/habitat/comments/5/1110/MATL/someuser/', {'MS': 'EU28', }],
...
def test_count_read_comments_view(app, client, set_auth,
